...
Code for Automation is in blow chunk. A table with some selected parameters are listed in below table, and the prediction accurate rate from two model is also compared in the plot.
