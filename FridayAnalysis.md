...
# MODEL SELECTION AND PREDICTION WITH FRIDAY DATA
...
![](FridayAnalysis_files/figure-gfm/weekdayCount-1.png)<!-- -->
...
The subset of Friday data has 39644 records and 59 features. Random
sample of 70% of the data (3993 rows) as the training dataset. The other
30% of the data (1708 rows) as the testing dataset.
...
![](FridayAnalysis_files/figure-gfm/channelPlot-1.png)<!-- -->
...
![](FridayAnalysis_files/figure-gfm/channelPlot-2.png)<!-- -->
...
The reduced model have **19** predictors which include features:
n\_unique\_tokens, data\_channel\_is\_entertainment,
data\_channel\_is\_bus, data\_channel\_is\_socmed,
data\_channel\_is\_tech, kw\_min\_min, kw\_avg\_min, kw\_min\_avg,
kw\_max\_avg, kw\_avg\_avg, self\_reference\_avg\_sharess, LDA\_00,
LDA\_02, global\_subjectivity, global\_rate\_positive\_words,
min\_positive\_polarity, max\_positive\_polarity,
...
![](FridayAnalysis_files/figure-gfm/linearModel_Prediction-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 3593, 3594, 3594, 3593, 3593, 3595, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  RMSE       Rsquared   MAE      
    ##    2    0.8634765  0.1285252  0.6380275
    ##    8    0.8605941  0.1314341  0.6356312
    ##   15    0.8637080  0.1253549  0.6377291
    ##   22    0.8629344  0.1270251  0.6373851
    ##   29    0.8622350  0.1287053  0.6369539
    ##   36    0.8644875  0.1244280  0.6375133
    ##   43    0.8638618  0.1257905  0.6373114
    ##   50    0.8642914  0.1249345  0.6369817
    ## 
...
![](FridayAnalysis_files/figure-gfm/randomForest-1.png)<!-- -->

``` r
plot(rfModel$finalModel)
```

![](FridayAnalysis_files/figure-gfm/randomForest-2.png)<!-- -->
...
![](FridayAnalysis_files/figure-gfm/rfprediction-1.png)<!-- -->
...
accurate rate is 0.5895785 with Friday data.
...
| :--------------------- | -----------------------: |
| Linear Model.Accuracy  |                0.5854801 |
| Random Forest.Accuracy |                0.5895785 |

For Friday data, the random forest model do a better job in the term of
prediction accuracy.
