...
# `r toupper(paste("Model selection and prediction with", params$weekday, "Data"))`
...
The final model selected from the random forest methods has mTry = `r rfModel$finalModel["mtry"]`  which is the number of variables available for splitting at each tree node. 
